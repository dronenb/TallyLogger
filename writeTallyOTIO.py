...
if len(sys.argv) > 1:
    ...
    dictMasterMobInfo = {'C-01': ['TapeName_C-01', [0, 128, 128]], 'C-02': ['TapeName_C-02', [0, 128, 128]], 'C-05': ['TapeName_C-05', [0, 128, 128]], 'C-06': ['TapeName_C-06', [0, 128, 128]], 'C-07': ['TapeName_C-07', [152, 251, 152]], 'C-08': ['TapeName_C-08', [152, 251, 152]], 'C-09': ['TapeName_C-09', [152, 251, 152]], 'C-10': ['TapeName_C-10', [152, 251, 152]], 'i-25': ['TapeName_i-25', [231, 126, 49]], 'i-30': ['TapeName_i-30', [255, 182, 193]], 'PGM': ['~pdbMHtn', [147, 112, 219]]}
    result_dir = "/Users/trevoraylward/Documents/GitHub/_TallyToAAF/otio/"
    edit_rate = 50
...
def writeTallyOTIO():
    ...
    for i in range(1,3): # needs to be one more than tracks required
        ...
        if i == 1 :
            tr1 = otio.schema.Track(name="V1 - Test") # name doesn't make it to Resolve
            st.append(tr1)
        ...
        if i == 2 :
            tr2 = otio.schema.Track(name="V2 - Test") # name doesn't make it to Resolve
            st.append(tr2)
